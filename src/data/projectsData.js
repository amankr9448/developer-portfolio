...
export const projectsData = [
  {
    id: 1,
    projectName: "Data Access Portal (Financial Data Store)",
    projectDesc:
      "Developed a financial visualization platform with a natural language interface, empowering 100+ users to generate dynamic JSON templates—accelerating analysis by 30%.",
